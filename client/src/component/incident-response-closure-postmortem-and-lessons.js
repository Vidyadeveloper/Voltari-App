...
class IncidentResponseClosurePostmortemAndLessons extends FormDesignerComponent {
   constructor() {
    super();
  }
  ...
  render() {
    ...
    `;
      ...
      fgincident.fields = [{"id":"incidentId","name":"Incident ID","type":"text","required":false,"description":"Unique identifier for the incident.","label":"Incident ID"},{"id":"description","name":"Description","type":"text","required":false,"description":"Detailed description and context for the incident.","label":"Description"}];
...
customElements.define("incident-response-closure-postmortem-and-lessons", IncidentResponseClosurePostmortemAndLessons);
export default IncidentResponseClosurePostmortemAndLessons;
