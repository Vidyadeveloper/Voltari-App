...
class DeviceHealthMonitoringResolutionResolveAndCloseIncident extends FormDesignerComponent {
   constructor() {
    super();
  }
...
customElements.define("device-health-monitoring-resolution-resolve-and-close-incident", DeviceHealthMonitoringResolutionResolveAndCloseIncident);
export default DeviceHealthMonitoringResolutionResolveAndCloseIncident;
