...
class FirmwareUpdateWorkflowRollbackorcontingencyNotifyStakeholders extends FormDesignerComponent {
   constructor() {
    super();
  }
...
customElements.define("firmware-update-workflow-rollbackorcontingency-notify-stakeholders", FirmwareUpdateWorkflowRollbackorcontingencyNotifyStakeholders);
export default FirmwareUpdateWorkflowRollbackorcontingencyNotifyStakeholders;
