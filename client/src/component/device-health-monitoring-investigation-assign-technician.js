...
class DeviceHealthMonitoringInvestigationAssignTechnician extends FormDesignerComponent {
   constructor() {
    super();
  }
  ...
  render() {
    ...
    `;
      ...
      fguser.fields = [{"id":"userId","name":"User ID","type":"text","required":false,"description":"Unique user identifier.","label":"User ID"},{"id":"name","name":"Full Name","type":"text","required":false,"description":"User full name.","label":"Full Name"}];
...
customElements.define("device-health-monitoring-investigation-assign-technician", DeviceHealthMonitoringInvestigationAssignTechnician);
export default DeviceHealthMonitoringInvestigationAssignTechnician;
