...
class IncidentResponseDetectionReportIncident extends FormDesignerComponent {
   constructor() {
    super();
  }
...
customElements.define("incident-response-detection-report-incident", IncidentResponseDetectionReportIncident);
export default IncidentResponseDetectionReportIncident;
